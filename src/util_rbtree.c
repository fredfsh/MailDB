...
util_rbtree_node_t* util_rbtree_gt_key(util_rbtree_t *rbtree, long key)
{
    ...
    {
        util_rbtree_node_t *node = NULL;  // result
        // node with the largest hash value less than or equal to key
...
util_rbtree_node_t* util_rbtree_geq_key(util_rbtree_t *rbtree, long key)
{
    ...
    {
        util_rbtree_node_t *node = NULL;  // result
        // node with the largest hash value strictly less than key
        util_rbtree_node_t *temp = rbtree->root;
        util_rbtree_node_t *null = _NULL(rbtree);
        while(temp != null)
        {
...
static void rbtree_mid_travel(util_rbtree_node_t *node,
    util_rbtree_node_t *sentinel, void(*opera)(util_rbtree_node_t *, void *),
    void *data)
{
